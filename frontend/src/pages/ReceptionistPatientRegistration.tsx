...
const ReceptionistPatientRegistration: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setError((err as Error).message || 'Unable to register patient right now.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="relative min-h-screen bg-center bg-cover" style={{ backgroundImage: "url('/images/Hero.png')" }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        <div className="w-full max-w-4xl">
          ...
          >
            <h1 className="mb-4 text-4xl font-extrabold text-white md:text-5xl">Register New Patient</h1>
            <p className="text-lg text-gray-200">Add a new patient to the system</p>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-800">Temporary Password</label>
                    ...
                    <p className="mt-2 text-xs text-gray-600">Patient can change this later</p>
                  </div>
              ...
              {isUnder18 && (
                <div className="mb-8 p-4 border-2 border-yellow-400 bg-yellow-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-700 mb-4">Since the patient is under 18, guardian information is required.</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
